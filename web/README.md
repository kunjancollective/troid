...
found six; run 12 passed 22 of 24, four errors. The fixes from all three are staged now (`CANDIDATE_LINTS`, `CANDIDATE_TOPIC_CITES` and a should-I refusal gated
