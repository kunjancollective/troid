# troid — social assets (built 24 Sep 2026 from brand/ canonical artwork)

| file | where it goes |
|---|---|
| x-avatar-400.png | X → Edit profile → photo (same as brand/mark-400.png) |
| x-header-1500x500.png | X → Edit profile → header |
| reddit-avatar-256.png | Reddit → profile → avatar/snoo image |
| reddit-banner-1920x384.png | Reddit → profile → banner |
