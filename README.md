...
| `.github/workflows/shadow.yml` | The daily loop: fresh bars from api.binance.us, `stitch_bars.py` onto the frozen sample, replay, journal, ledger, compare page, commit. |
...
test, and until it's been traded live with our own money for several months, we claim
nothing. If you ever see us claim
