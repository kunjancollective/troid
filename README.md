...
| `web/` | The site: troid's desk (the calculator), troid's compare, troid's ledger, troid's research (the dashboard, the tearsheet and the methodology), ask troid (the assistant, switched off until legal review), the FAQ and the terms. |
